...
/**
 * Create by hanshin on 2020/06/09 11:19 오전
 */
public class ExpiryDateCalculatorTest {

    @Test
    void 만원_남부하면_한달_뒤가_만료일이_됨(){
    ...
    void 이만원_이상_납부하면_비례해서_만료일_계산(){
        ...
        PayData payData3 = PayData.builder()
                .billingDate(LocalDate.of(2019, 3, 1))
                .payAmount(50_000).build();
        assertExpiryDate(payData3, LocalDate.of(2019,8,1));

        PayData payData4 = PayData.builder()
                .billingDate(LocalDate.of(2019, 3, 1))
                .payAmount(70_000).build();
        assertExpiryDate(payData4, LocalDate.of(2019,10,1));
    }
